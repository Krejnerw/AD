# Multiprocessing
# Ten kod należy uruchomić poza Jupyter Notebookiem, gdyż nie jest on obsługiwany dla tego przypadku.
# Pamiętaj o dodaniu zdefiniowanej wcześniej funkcji `count_time`.
...
if __name__ == '__main__':
    split_file('zamowienia_expanded.csv', 4_000_000, 'data')
    df4 = load_files('data')
    df4.info()